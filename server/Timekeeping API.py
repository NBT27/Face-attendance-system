...
def timekeeping():
    ...
    # Chuyển đổi hình ảnh từ định dạng PIL sang mảng numpy
    ...
    for face_location in face_locations:
        ...
        if label == 'real':
            ...
            search_result = client.search(
                collection_name=collection, query_vector=signature, with_vectors=True, limit=2
            )
            ...
            for scored_point in search_result:
                ...
                # print(f"id_temp: {id_temp}")
                # print(f"euclidean_score: {euclidean_score}")
